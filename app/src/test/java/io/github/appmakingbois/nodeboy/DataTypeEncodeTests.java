...
public class DataTypeEncodeTests {
    ...
    public void encodeUUIDTest(){
        System.out.println("Testing if UUID encoding works...");
    ...
    public void encodeIntTest(){
        System.out.println("Testing if VarInt encoding works...");
        int testNum = 420;
    ...
    public void encodeNegativeIntTest(){
        System.out.println("Testing if VarInt encoding works with negative numbers...");
        int testNum = -1337;
        assertTrue(PacketDecoder.decodeVarInt(PacketEncoder.encodeVarInt(testNum)) == testNum);
    }
    ...
    public void encodeLongTest(){
        System.out.println("Testing if VarLong encoding works...");
    ...
    public void encodeBooleanTest(){
        System.out.println("Testing if Boolean encoding works...");
        boolean t = true;
        boolean f = false;
    ...
    public void arrayConversionTest(){
        System.out.println("Testing if converting between byte arrays and ArrayList<Byte> works...");
